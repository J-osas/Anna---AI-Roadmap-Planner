...
export const Welcome: React.FC<WelcomeProps> = ({ onGetStarted }) => {
  return (
    <div className="w-full max-w-4xl mx-auto py-12 md:py-20 animate-in fade-in zoom-in-95 duration-700">
      <div className="relative">
        ...
        <div className="glass p-8 md:p-16 rounded-[3rem] border border-white shadow-2xl relative z-10 text-center overflow-hidden">
          {/* Top Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 rounded-full border border-indigo-100 mb-8">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-indigo-600">Anna AI is Live</span>
          </div>
          ...
          <div className="bg-slate-50/50 rounded-3xl p-6 md:p-8 border border-slate-100 mb-12 inline-block max-w-lg">
