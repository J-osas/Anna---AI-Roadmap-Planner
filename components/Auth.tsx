...
export const Auth: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-xl mx-auto py-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="glass p-10 md:p-14 rounded-[3rem] shadow-2xl border border-white relative overflow-hidden">
        {/* Background Decor */}
        ...
        <div className="relative z-10">
          ...
          {message && (
            <div className={`mb-8 p-5 rounded-2xl text-xs font-bold flex items-center gap-3 animate-in zoom-in-95 duration-300 ${
          ...
          <form onSubmit={handleAuth} className="space-y-5">
            <div className="space-y-2">
              ...
              <input
                type="email"
                required
                className="w-full px-5 py-4 rounded-2xl border border-slate-100 bg-white/50 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/5 outline-none transition-all text-sm font-bold text-slate-700 placeholder:text-slate-300 shadow-sm"
            ...
            <button
              type="submit"
              disabled={loading}
              className="group relative w-full mt-4 py-5 bg-indigo-600 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-indigo-100 hover:bg-indigo-700 hover:-translate-y-1 transition-all disabled:opacity-50 disabled:translate-y-0"
            >
              {loading ? (
                ...
                <span className="relative z-10 flex items-center justify-center gap-2">
                  {isSignUp ? 'Create My Account' : 'Unlock my Roadmap Library'}
          ...
          <div className="mt-10 pt-8 border-t border-slate-100 flex flex-col items-center gap-4">
            <button
              ...
              className="text-xs font-bold text-indigo-600 hover:text-indigo-800 transition-colors flex items-center gap-2"
            >
